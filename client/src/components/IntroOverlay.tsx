/*
 * IntroOverlay.tsx
 * Design: "Surgical Minimal" — Pure black/white, surgical precision
 * Typography-first layout with animated CTA button
 */
    ...
    <>
      ...
      >
        ...
        <div style={{ textAlign: "center", maxWidth: 680, padding: "0 40px" }}>
          ...
          {/* Title line 2 — lighter weight, faded */}
          <motion.h1
            initial={{ opacity: 0, y: 30, filter: "blur(10px)" }}
            animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          ...
          {/* CTA */}
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1, duration: 0.7 }}>
